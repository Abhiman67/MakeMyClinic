      ...
      <div className="w-full mx-auto bg-gray-900 bg-opacity-80 rounded-lg shadow-2xl">
        <div className="p-6 border-b border-gray-600 flex justify-between items-center">
          ...
          <button
            ...
            className="px-5 py-2 bg-amber-600 text-white font-semibold rounded-full shadow-lg hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-400 transition duration-200"
          >
            {isEditing ? (
              <>
