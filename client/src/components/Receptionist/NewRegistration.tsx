      ...
      <form className="mt-4 space-y-6" onSubmit={handleSubmit}>
        {/* <div className="flex flex-col">
          ...
          <input
            type="number"
            name="id"
            className="p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 outline-none text-base w-full"
        ...
        <div className="flex space-x-4">
          {/* <div className="flex-1 flex flex-col">
            ...
            <input
              type="number"
              name="age"
              className="p-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-amber-500 outline-none text-base"
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="py-3 px-6 bg-amber-600 text-white rounded-lg text-lg font-semibold hover:bg-amber-700 focus:ring-2 focus:ring-amber-300 transition-all"
          >
