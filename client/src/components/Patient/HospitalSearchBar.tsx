...
const HospitalSearchBar: React.FC<{ coordsCallback: (coords: number[] | null) => void }> = ({ coordsCallback }) => {
  ...
  return (
    ...
    <div className="absolute top-0 left-0 ml-6 w-full max-w-md mx-auto mt-8">
      <div className="flex items-center border border-gray-300 rounded-md shadow-sm bg-yellow-500">
        ...
        <input
          ...
          className="w-full p-2 pl-10 border-none rounded-l-none rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
        />
      </div>
