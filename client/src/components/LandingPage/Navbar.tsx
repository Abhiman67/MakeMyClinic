...
const Navbar = ({ isScrolled, activeSection, darkMode, setDarkMode }: NavbarProps) => {
  ...
  return (
    <nav className={`fixed w-full py-4 z-50 transition-all duration-300 ${isScrolled
      ...
      <div className="container mx-auto flex justify-between items-center px-6">
          ...
          {["home", "services", "features", "about", "testimonials"].map((section) => (
            <li key={section}>
              <Link
                ...
                smooth={true}
                duration={500}
                className={`cursor-pointer font-medium text-base transition-all duration-300 relative ${activeSection === section
                    ? isScrolled
                      ? "text-yellow-600 dark:text-yellow-400"
                      : darkMode
              ...
              >
                ...
                {activeSection === section && (
                  <motion.span
                    className="absolute bottom-0 left-0 w-full h-0.5 bg-yellow-500 dark:bg-yellow-400"
        ...
        <div className="flex items-center space-x-4">
          ...
          <motion.button
            onClick={handleLogin}
            className={`hidden md:block px-6 py-2 rounded-full font-medium transition-all duration-300 ${isScrolled
        ...
        <div className="md:hidden">
          <button className={`p-2 rounded-md ${isScrolled
